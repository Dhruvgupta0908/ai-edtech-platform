...
// FIXED — all hardcoded inline colors replaced with CSS variables
// so dark mode works correctly on every element.
...
const Dashboard = () => {
  ...
  const subjects = [
    { key: "operating-systems",      title: "Operating Systems",           icon: "💻" },
    { key: "computer-networks",      title: "Computer Networks",           icon: "🌐" },
    { key: "data-structures",        title: "Data Structures",             icon: "🧠" },
    { key: "algorithms",             title: "Algorithms",                  icon: "⚙️" },
    { key: "dbms",                   title: "Database Management Systems", icon: "🗄️" },
    { key: "compiler-design",        title: "Compiler Design",             icon: "🛠️" },
    { key: "discrete-mathematics",   title: "Discrete Mathematics",        icon: "📐" },
    { key: "theory-of-computation",  title: "Theory of Computation",       icon: "📘" },
  ];

  const [streak, setStreak] = useState({
    currentStreak: 0, longestStreak: 0, lastStudyDate: null, studiedToday: false
  });
      ...
      <div className="dashboard-content">
        ...
        <div style={{
          background:   hasStreak ? (
            /* amber tint works in both modes */
            "var(--streak-bg, #fff7ed)"
          ) : "var(--bg-secondary)",
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div>
              <p style={{ margin: 0, fontSize: "28px", fontWeight: 800, color, lineHeight: 1 }}>
          ...
          <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
            {dots.map((dot, i) => (
              <div key={i} style={{
                ...
                background: dot.studied ? color : "var(--border-color)"
              }} />
            ))}
          </div>

          {/* Message */}
          <p style={{ margin: 0, fontSize: "14px", color: "var(--text-primary)", flex: 1 }}>
            {message}
          </p>
